...
%prep
%setup -q -n google_cloud_storage-3.0.0
cd %{_builddir}/google_cloud_storage-3.0.0
pushd ..
cp -a google_cloud_storage-3.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738195423
