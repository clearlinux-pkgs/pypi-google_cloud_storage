...
Source0  : https://files.pythonhosted.org/packages/e6/41/ffa205e62a644ab63fecb795d139bc94ceee255f341b1fd33fa070e23461/google-cloud-storage-2.15.0.tar.gz
...
%prep
%setup -q -n google-cloud-storage-2.15.0
cd %{_builddir}/google-cloud-storage-2.15.0
pushd ..
cp -a google-cloud-storage-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709595782
