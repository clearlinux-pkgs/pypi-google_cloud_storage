...
Source0  : https://files.pythonhosted.org/packages/9f/9c/8cd4da7df57284832c3853aa565de278ca6d33a47ebe6722628488dc01ca/google-cloud-storage-2.7.0.tar.gz
...
%prep
%setup -q -n google-cloud-storage-2.7.0
cd %{_builddir}/google-cloud-storage-2.7.0
pushd ..
cp -a google-cloud-storage-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675274913
