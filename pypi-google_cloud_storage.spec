...
%prep
%setup -q -n google-cloud-storage-2.12.0
cd %{_builddir}/google-cloud-storage-2.12.0
pushd ..
cp -a google-cloud-storage-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697215649
