...
Source0  : https://files.pythonhosted.org/packages/17/c5/0bc3f97cf4c14a731ecc5a95c5cde6883aec7289dc74817f9b41f866f77e/google-cloud-storage-2.16.0.tar.gz
...
%prep
%setup -q -n google-cloud-storage-2.16.0
cd %{_builddir}/google-cloud-storage-2.16.0
pushd ..
cp -a google-cloud-storage-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710858217
