...
Source0  : https://files.pythonhosted.org/packages/f3/08/52143124415a889bbab60a8ecede1e31ea0e8d992ca078317886f26dc3be/google_cloud_storage-3.1.0.tar.gz
...
%prep
%setup -q -n google_cloud_storage-3.1.0
cd %{_builddir}/google_cloud_storage-3.1.0
pushd ..
cp -a google_cloud_storage-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740757997
