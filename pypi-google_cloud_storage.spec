...
Source0  : https://files.pythonhosted.org/packages/1d/f9/0096c3f32ee6087da902d8e450639f3659371052301cc8d5587f5fb288fe/google-cloud-storage-2.17.0.tar.gz
...
%prep
%setup -q -n google-cloud-storage-2.17.0
cd %{_builddir}/google-cloud-storage-2.17.0
pushd ..
cp -a google-cloud-storage-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718228899
