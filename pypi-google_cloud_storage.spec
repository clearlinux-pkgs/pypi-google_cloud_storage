...
Source0  : https://files.pythonhosted.org/packages/26/00/9d17394eba3e214ba3748d16eeac4b060d35a45da86061b3e3268077cc55/google_cloud_storage-2.18.0.tar.gz
...
%prep
%setup -q -n google_cloud_storage-2.18.0
cd %{_builddir}/google_cloud_storage-2.18.0
pushd ..
cp -a google_cloud_storage-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721695661
