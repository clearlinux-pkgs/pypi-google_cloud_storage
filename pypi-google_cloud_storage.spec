...
Source0  : https://files.pythonhosted.org/packages/f1/94/665b3b7394477704cc3e894e37e04aa7c68575d30f46c62dff9ef8f2e8a6/google-cloud-storage-2.13.0.tar.gz
...
%prep
%setup -q -n google-cloud-storage-2.13.0
cd %{_builddir}/google-cloud-storage-2.13.0
pushd ..
cp -a google-cloud-storage-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698851964
