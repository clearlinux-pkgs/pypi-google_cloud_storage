...
Source0  : https://files.pythonhosted.org/packages/36/76/4d965702e96bb67976e755bed9828fa50306dca003dbee08b67f41dd265e/google_cloud_storage-2.19.0.tar.gz
...
%prep
%setup -q -n google_cloud_storage-2.19.0
cd %{_builddir}/google_cloud_storage-2.19.0
pushd ..
cp -a google_cloud_storage-2.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733396029
